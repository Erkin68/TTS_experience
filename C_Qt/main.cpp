...
//#include "/home/erkin/tensorflow/tensorflow/core/public/session_options.h"
...
int main(int argc, char **argv)
{
  ...
  //auto options1 = tensorflow::SessionOptions();
  //options1.config.mutable_gpu_options()->set_per_process_gpu_memory_fraction(0.2);
  //options1.config.mutable_gpu_options()->set_allow_growth(true);
  //tensorflow::Status status = tensorflow::NewSession(options1, &session);
  ...
  //tf_synthesizer.session.init(argc, argv);
